...
The Cumulative XType extension requires WeeWX v4.6.0 or greater and will operate
under Python 2 or Python 3.
...
4.  You may now use the aggregate type 'cumulative' to produce cumulative
series data with user selectable reset times.
